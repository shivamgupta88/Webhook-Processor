...
function LandingPage({ onNavigate }) {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "RESTful APIs, comprehensive docs, and easy integration.",
    },
  ];
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <button
            onClick={() => onNavigate("demo")}
            className="md:hidden bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition-colors font-medium"
          >
            Demo
          </button>
        </div>
